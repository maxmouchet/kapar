#!/usr/bin/env perl
#
# $Id: plot-addr-period-percentiles.pl,v 1.1 2008/07/07 17:35:37 kkeys Exp $
#
...
plot("addr-period-percentiles-teamX-${min_appearances}.png",
    "minimum",
    "25th percentile",
    "50th percentile",
    "75th percentile",
